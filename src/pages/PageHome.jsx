...
function PageHome() {
    ...
    return (
		...
		<img src="https://img.youtube.com/vi/5GrxYha5Vwo/maxres1.jpg" className="bannerImg h-full w-full object-cover opacity-90 absolute top-0 left-0 brightness-75" />
		<div id="homeBanner">
            <img src="https://img.youtube.com/vi/5GrxYha5Vwo/maxresdefault.jpg" />
        </div>
		...
		<div className="scroll-invitation hidden min-[800px]:block absolute bottom-0 left-[50%] -translate-x-[50%] fill-white mx-auto mb-[25px]">
